...
for C in combinations(cs,3):
 ...
 print('FOUND',C,'degrees',degrees,flush=True);out={'schema':'hard_three_distinct_boundary_points_v1','center':J['center'],'supports':[[k for k in I] for I,p in C],'points':points,'degrees':degrees,'circuits_at_center':len(cs)};(P/'UNIQUE_HARD_THREE_BOUNDARY_POINTS.json').write_text(json.dumps(out,indent=2)+'\n');break
