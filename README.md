...
| 9DVL / realizability | **2/9 proved**; the first two four-support domains have exact coverage/projection, 265,962 open-sector cells, and 213,125 cells on 1,385 completed algebraic fibers, but 308 harder sections, `v` lifting, the global closure complex, and both diagonal-three invariant obligations remain open | [`ai/omreal/`](ai/omreal/) |
