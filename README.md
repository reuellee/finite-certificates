...
| 9DVL / realizability | **2/9 proved**; the first two four-support domains have a complete 527,533-cell base CAD, the open-base-cell `v` lift certifies 4,496,636 cells, and all 132,134 open-`t` algebraic-`u` sections are lifted to 4,047,846 cells; algebraic-`t` `v` lifts over 261,571 base cells, global gluing, labels, middle-rank replay, and both diagonal-three invariant obligations remain open | [`ai/omreal/`](ai/omreal/) |
