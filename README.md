...
| 9DVL / realizability | **2/9 proved**; the first two four-support parent domains have exact square-pyramid coverage, a complete 2,554-polynomial second projection, and 1,693 exactly isolated and ordered interior `t` sections, but base/fiber lifting, the global closure complex, and both diagonal-three invariant obligations remain open | [`ai/omreal/`](ai/omreal/) |
