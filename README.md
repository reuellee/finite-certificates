...
| 9DVL / realizability | **2/9 proved**; the first two four-support domains have exact coverage/projection, 265,962 open-sector cells, and 261,571 cells on all 1,693 algebraic fibers, but `v` lifting, the global closure complex, labels, middle-rank replay, and both diagonal-three invariant obligations remain open | [`ai/omreal/`](ai/omreal/) |
