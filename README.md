...
| 9DVL / realizability | **2/9 proved**; the first two four-support domains have a complete 527,533-cell base CAD, and the open-base-cell portion of the `v` lift certifies 4,496,636 cells over all 133,828 full-dimensional open base cells; `v` lifts over algebraic base sections, global gluing, labels, middle-rank replay, and both diagonal-three invariant obligations remain open | [`ai/omreal/`](ai/omreal/) |
