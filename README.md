...
- certified with **105 exact parent-safe segments** that **10,844 of 17,824** full-support residual walls genuinely meet the strict parent interior;
- retained the remaining **6,980 factors explicitly open**, rather than inferring emptiness from sampling;
...
The next exact target is the 6,980-factor full-support residue, using algebraic sign-implication certificates and exact feasibility on symmetry representatives.
...
The current diagonal-three frontier is deliberately fail-closed. Of 17,824 candidate full-support residual factors, 10,844 are proved to occur in the strict parent interior and 6,980 remain unresolved. A constant sign on the stored point bank is treated only as reconnaissance, never as an emptiness certificate.
...
| 9DVL / realizability | **2/9 proved**; diagonal 3 reduced to an exact full-support frontier with 6,980 unresolved factors | [`ai/omreal/`](ai/omreal/) |
