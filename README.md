...
- completed the second projection of those 136 polynomials: **114** base curve factors yield **6,061** nonconstant obligations, **2,554** distinct squarefree univariate projection polynomials, and an exact **1,693** interior factor-root incidence frontier of maximum degree 10;
...
| 9DVL / realizability | **2/9 proved**; the first two four-support parent domains have exact square-pyramid coverage and a complete 2,554-polynomial second projection with 1,693 root incidences, but root isolation, the lifted global closure complex, and both diagonal-three invariant obligations remain open | [`ai/omreal/`](ai/omreal/) |
