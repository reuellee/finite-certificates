...
| 9DVL / realizability | **2/9 proved**; the first two four-support domains have a complete local inventory of 527,533 base cells and 16,935,101 lifted cells with zero unresolved local `v` fibers; global gluing, complete labels, true infinity, middle-rank replay, and both diagonal-three invariant obligations remain open | [`ai/omreal/`](ai/omreal/) |
