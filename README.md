...
| 9DVL / realizability | **2/9 proved**; the first two four-support parent domains have exact square-pyramid coverage, a complete 2,554-polynomial second projection, 1,693 ordered `t` sections, and 265,962 certified open-sector base cells, but algebraic-section/`v` lifting, the global closure complex, and both diagonal-three invariant obligations remain open | [`ai/omreal/`](ai/omreal/) |
