...
- proved exact `S3` symmetry under permutation of the three moving columns and transported those witnesses to **5,986 additional walls**;
- thereby certified **16,830 of 17,824** full-support candidate walls as interior-nonempty, leaving only **994 explicitly unresolved**;
...
The next exact target is the 994-factor full-support residue, quotiented by the same exact moving-column symmetry and attacked with algebraic sign-implication or exact feasibility certificates.
...
| 9DVL / realizability | **2/9 proved**; diagonal 3 reduced to an exact full-support frontier with 994 unresolved factors | [`ai/omreal/`](ai/omreal/) |
