...
**September 9 exploration checkpoint:** independent review accepted an exact
full-block feasibility boundary, a transverse escape proving one specified
triple-bad component noncompact, a scoped coherent-witness example, and a
narrow endpoint-hybrid obstruction. The ledger remains **2/9**; all seven
global obligations remain open and no source orbits were removed. See the
[exploration report](ops/research-team/cycles/2026-09-09-exploration/CYCLE_REPORT.md),
[independent review](ops/team/d3-explore-referee/FINAL_REVIEW.md), and
[publication and replay instructions](ops/research-team/publications/2026-09-09-exploration/README.md).
The following strategy account records the earlier V11 checkpoint; the dated
exploration close records the subsequent experiments and their limits.
