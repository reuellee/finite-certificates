...
canaries in two and three dimensions.  In particular, it requires the critical
system method to exclude a noncompact hyperboloid-like zero set and to refuse
to exclude an interior sphere, whose compact component is an intentional
hostile example.
